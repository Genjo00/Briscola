...
def newgame():
    ...
    for c in range(20):
        if win == 0:                                                            #Se hai vinto la scorsa mano
            ...
            if c > 16 and [9,b] in mano and [8,b] in cmano:
                cmano1 = cmano.index([8,b])
            elif c > 16 and [7,b] in cmano and ([9,b] in mano or [8,b] in mano):
                cmano1 = cmano.index([7,b])
            elif punti >9:#se player ha giocato asso o tre non di briscola, computer gioca la briscola più bassa che ha in mano se ne ha almeno una
            ...
            cplay = cmano[cmano1]
            del cmano[cmano1]
            if cplay[0]== 9:    #asso        #Punti giocati computer
                cpunti = 11
            elif cplay[0] == 8: #tre
                cpunti = 10
            elif cplay[0] == 7: #re
                cpunti = 4
            elif cplay[0] == 6: #cavallo
                cpunti = 3
            elif cplay[0] == 5: #donna
                cpunti = 2
            else:
                cpunti = 0
            print('\n'+'-'*30+'|'+'-'*30) #tabellina
            ...
            cplay = cmano[cmano1]
            del cmano[cmano1]
            if cplay[0]== 9:    #asso       #Calcolo punti giocati
                cpunti = 11
            elif cplay[0] == 8: #tre
                cpunti = 10
            elif cplay[0] == 7: #re
